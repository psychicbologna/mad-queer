...
const crisisLinks = [
  ...
  },
  {
    ...
    postscript:
      'Hotline available in Cantonese, Mandarin, Japanese, Korean, and Fujianese'
  },
  {
...
export const ConnectPage = () => {
  ...
  return (
    <Page className="Connect" meta={pageMeta}>
      <div className="Alert">
        <p>
          If you are looking for support and are currently in an emotional
          crisis, I recommend checking out the following groups and hotlines.
        </p>
      ...
      <div>
        ...
        <p>
          I offer sliding scale training rates for organizations and
          collectives, which is based on your budget, staff size and length of
          training. Please feel free to follow up with me below!
        </p>
        <p>
          I prioritize and center my trainings for Survivors and Queer, Trans,
          Disabled, Black, Indigenous and People of Color communities.
        </p>
        <p>
          All of my Safety and Wellness planning materials are free, you can
          access them <LocalLink to={'/madqueer'}>here</LocalLink>.
        </p>
      </div>
      <div className="Action">
        <LinkButton href="https://elliott119849.typeform.com/to/pbHmqpkf">
